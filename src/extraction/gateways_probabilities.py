...
class GatewaysEvaluator:
    """
        This class evaluates the gateways' probabilities according to a specified method defined by the user
     """
    ...
    def define_probabilities(self) -> None:
        """
        Defines the gateways' probabilities according to a specified method
        """
        ...
        if self.method == 'discovery':
            ...
            gateways = self.analyze_gateways_equi()
        ...
        self.probabilities = gateways[['gatewayid', 'out_path_id', 'prob']].to_dict('records')  # sup.print_done_task()
    ...
    def analyze_gateway_structure(self) -> pd.DataFrame:
        """
    ...
    def analyze_gateways(self) -> pd.DataFrame:
        """
        Discovers the gateway's paths probabilities according to the
    ...
    def analyze_gateways_equi(self) -> pd.DataFrame:
        """
